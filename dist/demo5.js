...
(0, _safir.On)("app.ready", () => {
  app.loadComponent(new _rocketCraftingAccount.default(), 'bg-transparent');
  document.body.classList.add('funnyBg2');
});

},{"./layouts/rocket-crafting-account":3,"safir":4}],3:[function(require,module,exports){
"use strict";
...
},{"../components/simple-btn":1,"safir":4}],4:[function(require,module,exports){
'use strict';
