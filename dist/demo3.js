...
class MyInput extends _safir.BaseComponent {
  id = '';
  value = '';
  type = 'number';
  ready = () => {};
...
},{"safir":4}],2:[function(require,module,exports){
"use strict";

var _safir = require("safir");
var _bodyInput = _interopRequireDefault(require("./layouts/body-input"));
function _interopRequireDefault(obj) { return obj && obj.__esModule ? obj : { default: obj }; }
let app = new _safir.Safir();
(0, _safir.On)("app.ready", () => {
  let p = app.loadComponent(new _bodyInput.default(), 'myScroll');
  console.info("Application running demo3 [npm service]...", Date.now());
});

},{"./layouts/body-input":3,"safir":4}],3:[function(require,module,exports){
"use strict";
...
exports.default = void 0;
var _safir = require("safir");
var _myInput = _interopRequireDefault(require("../components/my-input"));
function _interopRequireDefault(obj) { return obj && obj.__esModule ? obj : { default: obj }; }
class TestInputBody extends _safir.BaseComponent {
  id = 'testInputBody';
  memoryValue = 0;
  memoryValue2 = 0;
  myInputLevel0 = new _myInput.default({
    value: '1',
    id: 'myInputLevel0',
    type: 'number',
    min: 0,
...
exports.default = TestInputBody;

},{"../components/my-input":1,"safir":4}],4:[function(require,module,exports){
'use strict';
...
},{"./src/core/comp":5,"./src/core/modifier":7,"./src/core/root":8,"./src/core/utils":9}],5:[function(require,module,exports){
"use strict";
